			...
			<div className="grantsawards-container_content">
				<div class="grantsawards_items">
					<p>
						...
						protocolos de atención en salud. Revista Colombiana de Tecnologias de Avanzada (RCTA), 2(44), 45–54. <br />
				...
				<div class="grantsawards_items">
					<p>
						...
						Cognitive Informatics & Cognitive Computing (ICCI* CC), 147-152. <br />
